...
const words = ["Healing", "Well-being", "Self-care", "Balance", "Clarity"];
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
        Unlock Your Path to <FlipWords words={words} />
        <br />
        with EASE.
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        Take control of your mental health, reduce stress, and build a healthier
        mindset with EASE. Explore our journaling tools, mood tracker, AI
        support, and focus features to help you reflect, grow, and improve your
        well-being.
      </p>
    </div>
  );
